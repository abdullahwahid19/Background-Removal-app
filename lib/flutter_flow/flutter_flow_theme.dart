...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF2091F9);
  late Color secondaryColor = const Color(0xFF39D2C0);
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFFFFDFA);
  late Color secondaryBackground = const Color(0x004C4D56);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF2091F9);

  late Color primaryBtnText = Color(0xFF2091F9);
  late Color lineColor = Color(0xFFE0E3E7);
  late Color btnText = Color(0xFF000000);
